---
name: coingecko-api
description: Generate Python code for the CoinGecko API using ONLY the official `coingecko_sdk`.
---

# Skill: CoinGecko API Integration
...
5.  **Pydantic Responses**:
    - The SDK returns Pydantic models, not standard dictionaries.
    - When passing data to the frontend or database, always use `.to_dict()` or `.to_json()` on the response objects.
